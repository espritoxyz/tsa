...
class Statements {
    ...
    fun checkSendInRepeat3() {
         ...
         */
        checkFailedSendInStatement(sendInRepeatChecker3, listOf(
            listOf(102, 103, 103),
            listOf(102, 103, 102),
            listOf(102, 102, 103),
            listOf(102, 102, 102),
    ...
    fun checkSendInRepeat4() {
        ...
        // 4 iterations or more reaches the limit in which TSA unfolds repeats. As such, there shouldn't be
        // failures in the test results.
        checkSuccessfulSendInStatement(sendInRepeatChecker4)
    }
    ...
    fun checkSendInWhile3() {
        ...
        // 3 iterations or more reaches the limit in which TSA unfolds whiles. As such, there shouldn't be
        // failures in the test results.
        checkSuccessfulSendInStatement(sendInWhileChecker3)
    }
    ...
    fun checkSendInUntil3() {
         ...
         */
        checkFailedSendInStatement(sendInUntilChecker3, listOf(
            listOf(102, 103, 103),
            listOf(102, 103, 102),
            listOf(102, 102, 103),
            listOf(102, 102, 102),
